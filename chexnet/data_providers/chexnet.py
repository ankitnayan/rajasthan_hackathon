...
class CHEXNDataSet(ImagesDataSet):
    n_classes = 6
...
class CHEXNDataProvider(DataProvider):
    def __init__(self, save_path=None, validation_set=None,
        ...
        for part in ['train']:
            ...
            #images, labels = self.get_images_and_labels(part)
    ...
    def get_images_and_labels(self, name_part, one_hot=False):
        ...
        if name_part=='train':
            filename = '/mnt/disks/data-dir/data/data_model_60k/train_data/output_1ch_train.mat'
        if name_part=='test':
            filename = '/mnt/disks/data-dir/data/data_model_60k/test_data/output_1ch_test.mat'
...
if __name__ == '__main__':
    ...
    dataset = CHEXNDataProvider(shuffle=True)
    plot_images_labels(
        dataset.train.images[:n_plots],
        dataset.train.labels[:n_plots],
        axes[1],
